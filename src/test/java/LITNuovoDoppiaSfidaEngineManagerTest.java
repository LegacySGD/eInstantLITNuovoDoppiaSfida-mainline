...
public class LITNuovoDoppiaSfidaEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(LITNuovoDoppiaSfidaEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/LITNuovoDoppiaSfidaIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/LITNuovoDoppiaSfidaIW/InitOutcome.xml").getDocumentElement();
